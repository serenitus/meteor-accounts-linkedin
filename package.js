Package.describe({
    name: 'simonturvey:accounts-linkedin',
    summary: 'Accounts service for LinkedIn accounts',
    version: '1.2.0',
    git: 'https://github.com/serenitus/meteor-accounts-linkedin.git'
});
...
Package.onUse(function (api) {
    ...
    api.use('simonturvey:linkedin@1.2.1', ['client', 'server']);
...
Package.onTest(function (api) {
    ...
    api.use('simonturvey:accounts-linkedin');
